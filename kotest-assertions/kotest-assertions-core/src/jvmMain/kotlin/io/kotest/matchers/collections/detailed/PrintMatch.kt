...
fun<T> printMatches(leftList: List<T>, rightList: List<T>, matches: List<RangeMatch>): String {
...
fun<T> printMatch(leftList: List<T>, match: RangeMatch): String{
    return with(StringBuilder("\nMatch:\n")) {
...
fun<T> printMismatch(leftList: List<T>, rightList: List<T>, match: RangeMatch): String{
    return with(StringBuilder("\nMismatch:\n")) {
